...
function commonGetPricingData() {
  getAllPricing(function (response) {
    ...
    // checkout + razorpay open
      ...
      //   commonSaveInfoToLocalStorage(currentPackageId);
      //   console.log(JSON.parse(localStorage.getItem("packageDetails")));
      //   coupon applied
      ...
      if (coupon) {
        checkCoupon(
          ...
          (discount) => {
            ...
            couponAppliedSuccessfullyUsingURL = true;
            commonSaveInfoToLocalStorage(currentPackageId);
            packageTypeShow();
            openCheckoutModal(currentPackageId)
          },
...
function preparePayment(e = "none") {
  if (
    ...
    var waitingForVerifiedUser = async () => {
       var waiting = await setInterval(()=>{
            if(verifiedUser){
